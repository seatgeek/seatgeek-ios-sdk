...
/**
* An array of POST or PATCH fields and values to send with the request.
*/
@property (nullable, nonatomic, strong) NSArray *parametersList;
...
/**
* The format to use for request parameters (HTTP, JSON).
*/
@property (nonatomic, assign) SGHTTPDataType requestFormat;

/**
* The format to expect and parse for response data (HTTP, JSON).
*/
