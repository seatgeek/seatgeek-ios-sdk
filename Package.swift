...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SeatGeekSDKTG",
            url: "https://seatgeek.jfrog.io/artifactory/sdk-ios/5.1.0/SeatGeekSDK.xcframework.zip",
            checksum: "47cd7ec3d80513f3c7e9779f06bffe19b943ff3b644fee86126ff7d6b2f5ada4"
        ),
        .binaryTarget(
            name: "SnapKitTarget",
