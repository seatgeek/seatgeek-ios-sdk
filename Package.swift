...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SeatGeekSDKTG",
            url: "https://seatgeek.jfrog.io/artifactory/sdk-ios/debug/4.8.1/SeatGeekSDK-aa.xcframework.zip",
            checksum: "a9e6eac8d3cc7cb42cd1cd5f412cd0fe5f4b01be55962723ddf795f8d2cb56e0"
        ),
        .binaryTarget(
            name: "SnapKitTarget",
