...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SeatGeekSDKTG",
            url: "https://seatgeek.jfrog.io/artifactory/sdk-ios/4.6.0/SeatGeekSDK.xcframework.zip",
            checksum: "71146013fce754ccbfbdccaa64acee3ecb73c88e967c205b949d05e6c574c803"
        ),
        .binaryTarget(
            name: "SnapKitTarget",
